...
- Hero Home adalah campaign slider full-bleed (lebar penuh layar, gaya campaign IKEA): track `translateX` per slide, dimensi mengikuti rasio referensi campaign IKEA `aspect-[1024/426]` (±2.4:1; sumber desain rekomendasi `2048 × 852 px`; crop responsif menjaga area tengah), min-height `320px` di layar kecil, tombol back/next bulat putih di tepi kiri/kanan banner, dot indikator di bawah, auto-advance 6 detik, dan menghormati reduced motion. CTA graphite `Belanja Sekarang` (`rounded-full`).
