...
class CatalogTemplateDataSheet implements FromArray, WithTitle, WithEvents
{
    ...
    public function array(): array
    {
        return [[
            ...
            'height_cm', 'width_cm', 'depth_cm', 'specifications',
    ...
    private function setColumnWidths($sheet): void
    {
        $w = [
            ...
            'S' => 10, 'T' => 10, 'U' => 10, 'V' => 10,
            'W' => 40, 'X' => 40, 'Y' => 40, 'Z' => 40, 'AA' => 40, 'AB' => 40,
...
class CatalogTemplateExampleSheet implements FromArray, WithTitle, WithEvents
{
    ...
    public function array(): array
    {
        return [
            ...
            [
                'Jendela Aluminium Jungkit Ornamen 200x180',
                'Jendela jungkit aluminium dengan ornamen, kaca buram.', 'JENDELA',
                'JUNGKIT', 'ORNEMEN', 'Warna', 'Putih', 'Kaca', 'Buram',
                null, null, null, null, null, null,
                '10170000', '5', '45', '200', '180', '10',
                '[{"name":"Bahan","value":"Aluminium"}]',
...
class CatalogTemplateGuideSheet implements FromArray, WithTitle, WithEvents
{
    ...
    public function array(): array
    {
        return [
            ...
            ['variation_1_name', 'OPTIONAL', 'Nama variasi untuk baris ini, mis. "Warna".'],
            ['variation_1_option', 'OPTIONAL', 'Nilai opsi untuk baris ini, mis. "Hitam". Produk dengan beberapa opsi: tulis beberapa baris dengan nama sama (lihat Contoh).'],
            ['variation_2_name', 'OPTIONAL', 'Nama variasi kedua untuk baris ini, mis. "Kaca".'],
            ['variation_2_option', 'OPTIONAL', 'Nilai opsi kedua untuk baris ini, mis. "Bening".'],
            ['variation_3_name', 'OPTIONAL', 'Nama variasi ketiga untuk baris ini, mis. "Ukuran".'],
            ['variation_3_option', 'OPTIONAL', 'Nilai opsi ketiga untuk baris ini, mis. "200x180".'],
            ['variation_4_name', 'OPTIONAL', 'Nama variasi keempat untuk baris ini.'],
            ['variation_4_option', 'OPTIONAL', 'Nilai opsi keempat untuk baris ini.'],
