...
/**
 * Meta for cms_pages.slug = hasil-pemasangan (Hasil Pemasangan / /reviews#hasil-pemasangan).
 */
class InstallationPageSettings
{
    public const PAGE_SLUG = 'hasil-pemasangan';

    public const DEFAULT_TITLE = 'Hasil Pemasangan';
