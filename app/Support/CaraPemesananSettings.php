...
class CaraPemesananSettings
{
    ...
    public const DEFAULT_STEPS = [
        [
            ...
            'points' => ['Filter berdasarkan kategori, model bukaan, dan desain', 'Lihat detail material dan foto produk'],
        ],
        [
            'icon' => 'package',
        ...
        [
            ...
            'description' => 'Isi nama, nomor HP, dan alamat lengkap (provinsi hingga desa). Ongkir dihitung otomatis, pilih metode pembayaran, lalu buat pesanan.',
