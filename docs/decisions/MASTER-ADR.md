...
- **ADR-024** - SUPERSEDED 2026-09-20. Pengaturan teks storefront adalah lapisan PEMBANDING, bukan sumber teks: kolom kosong berarti storefront memakai teksnya sendiri, dan teks live dibaca dari satu berkas bersama PHP dan React. Digantikan karena lapisan pengaturan CTA dihapus dan teks pindah ke kode di `resources/js/lib/cta-content.ts`.
- **ADR-026** - Accepted 2026-09-23. Kontrak perhitungan dibekukan versi 1.0.0: delapan lapis perhitungan uang dan Performa Toko dilindungi golden test berkas expectation beku, komentar FROZEN, dan Gerbang Kontrak Beku pada template PR. end_exclusive sengaja di luar beku, menunggu keputusan owner soal restatement.
