    ...
    public function test_home_prefers_curated_homepage_popular_products(): void
    {
        ...
        $this->get('/')
            ...
            ->assertInertia(fn (AssertableInertia $page) => $page
                ...
                ->has('nav.public.hamburger', 9)
                ->where('nav.public.hamburger.0.label', 'Model Produk')
                ->where('nav.public.hamburger.1.label', 'Semua Produk')
                ->where('nav.public.hamburger.3.label', 'Flash Sale')
                ->where('nav.public.hamburger.6.label', 'Informasi Toko')
